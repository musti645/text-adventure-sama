...
describe('SceneBuilder.', () => {
    ...
    it('#setActionNotRecognizedResponse should set the ActionNotRecognizedResponse of the Scene to the passed Value', () => {
    ...
    it('#setItemNotFoundResponse should throw an error when trying to set an undefined ItemNotFoundResponse'
        + ' AND not set the Property.', () => {
            testBuilder.setItemNotFoundResponse(testScene.getItemNotFoundResponse());
    ...
    it('#setItemNotFoundResponse should throw an error when trying to set a null ItemNotFoundResponse AND not set the Property.', () => {
        testBuilder.setItemNotFoundResponse(testScene.getItemNotFoundResponse());
        expect(() => testBuilder.setItemNotFoundResponse(null)).toThrowError(EvalError);
        expect(testBuilder.getScene().getItemNotFoundResponse()).toBe(testScene.getItemNotFoundResponse());
    });

    it('#setItemNotFoundResponse should throw an error when trying to set an empty ItemNotFoundResponse AND not set the Property.', () => {
        testBuilder.setItemNotFoundResponse(testScene.getItemNotFoundResponse());
    ...
    it('#setInvalidInputResponse should set the InvalidInputResponse of the Scene to the passed Value', () => {
    ...
    it('#setInvalidInputResponse should throw an error when trying to set an undefined InvalidInputResponse'
        + ' AND not set the Property.', () => {
            testBuilder.setInvalidInputResponse(testScene.getInvalidInputResponse());
    ...
    it('#setInvalidInputResponse should throw an error when trying to set a null InvalidInputResponse AND not set the Property.', () => {
        testBuilder.setInvalidInputResponse(testScene.getInvalidInputResponse());
        expect(() => testBuilder.setInvalidInputResponse(null)).toThrowError(EvalError);
        expect(testBuilder.getScene().getInvalidInputResponse()).toBe(testScene.getInvalidInputResponse());
    });

    it('#setInvalidInputResponse should throw an error when trying to set an empty InvalidInputResponse AND not set the Property.', () => {
        testBuilder.setInvalidInputResponse(testScene.getInvalidInputResponse());
